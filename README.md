...
<h4> Para que el script haga su trabajo se debe guardar en la misma carpeta del Script un archivo .txt con el nombre doc.txt donde doc.txt es toda la información que nos entrega RegShot</h4>
